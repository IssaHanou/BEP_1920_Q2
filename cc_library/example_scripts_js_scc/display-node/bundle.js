        ...
        class Device {
          ...
          constructor(config, logger) {
            ...
            if (typeof this.getStatus !== "function") {
              throw new TypeError(
                "abstract method 'getStatus' not implemented"
              );
            }
 ...
 */
          ...
          (function ExportLibrary(root, factory) {
            ...
            var PahoMQTT = (function(global) {
              ...
              ClientImpl.prototype.subscribe = function(
                filter,
                subscribeOptions
              ) {
                ...
                wireMessage.topics =
                  filter.constructor === Array ? filter : [filter];
              ...
              ClientImpl.prototype._requires_ack = function(wireMessage) {
                ...
                while (
                  this._sentMessages[this._message_identifier] !== undefined
                ) {
                      ...
                      if (this._buffered_msg_queue.length > 0) {
                        ...
                        while ((msg = this._buffered_msg_queue.pop())) {
                          ...
                          if (this.onMessageDelivered)
                            this._notify_msg_sent[
                              msg
                            ] = this.onMessageDelivered(msg.payloadMessage);
                        }
                      }
